...
from utils.noise_layers.noises_tile import Rotation, CropandResize, GaussianBlur, GaussianNoise, ColorJitter, Sharpness, random_int
import kornia as K
        ...
        for layer in noise_layers:
            if type(layer) is str:
                if layer == 'Identity':
                    ...
                    self.noise_layers.append(CropandResize())
...
# the following code need to be changed to accommadate "robustness enhance fine-tuning"
