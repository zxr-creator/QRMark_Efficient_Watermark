...
EXPIREMENT_NAME="exp_num_bits"
# Set CUDA devices
export CUDA_VISIBLE_DEVICES=0
# Tile sizes to iterate over
NUM_BITS=(40 48 56 64 72 80 96)
for NUM_BIT in "${NUM_BITS[@]}"; do
  ...
  torchrun --nproc_per_node=1 --master_port=$MASTER_PORT main.py  \
    ...
    --output_dir "output/${EXPIREMENT_NAME}_${NUM_BIT}_${TIMESTAMP}" \
    --eval_freq 10 \
    --num_bits $NUM_BIT --img_size 256 --batch_size 16 --epochs 400 \
